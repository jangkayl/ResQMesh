...
The transport-promotion run supports that tested behavior only. The Samsung runs are blocking failed validation and do not establish cross-OEM readiness, explicit-LE success, block semantics, three-phone routing, all disconnect paths, or production reliability.
